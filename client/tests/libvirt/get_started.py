...
if __name__ == "__main__":
    ...
    libvirt_test_dir = os.path.dirname(sys.modules[__name__].__file__)
    libvirt_test_dir = os.path.abspath(libvirt_test_dir)
    config_file_list = glob.glob(os.path.join(libvirt_test_dir, "*.cfg.sample"))
    ...
    # libvirt uses the same winutils.iso as used by the kvm client test
    ...
    client_dir = os.path.abspath(os.path.join(libvirt_test_dir, "..", ".."))
    autotest_bin = os.path.join(client_dir, 'bin', 'autotest')
    control_file = os.path.join(libvirt_test_dir, 'control')
