...
from autotest.client.virt import kvm_monitor, virt_test_utils, virt_utils, virt_vm, aexpect, virt_storage
from autotest.client.virt import virt_env_process


@error.context_aware
def run_block_mirroring(test, params, env):
    """
    ...
    image_mirror = "%s-mirror.%s" % (image_name, image_format)
